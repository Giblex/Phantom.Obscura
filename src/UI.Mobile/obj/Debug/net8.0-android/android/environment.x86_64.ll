...
@dso_cache = dso_local local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 659322767899320031, ; hash 0x92662906cf75edf, from name: sodium.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libsodium.so
	...
	%struct.DSOCacheEntry {
		i64 2416320235504864717, ; hash 0x21887e73b4db0dcd, from name: Yubico.NativeShims.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libYubico.NativeShims.so
		ptr null; void* handle (0x0)
	}, ; 3
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4154686926294524853, ; hash 0x39a869bf3abea3b5, from name: libsodium
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libsodium.so
		ptr null; void* handle (0x0)
	}, ; 6
	...
	%struct.DSOCacheEntry {
		i64 10167229516646214895, ; hash 0x8d19416089906cef, from name: sodium
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libsodium.so
		ptr null; void* handle (0x0)
	}, ; 24
	...
	%struct.DSOCacheEntry {
		i64 12242780499469524445, ; hash 0xa9e717ffcdf5dddd, from name: libsodium.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libsodium.so
		ptr null; void* handle (0x0)
	}, ; 29
	%struct.DSOCacheEntry {
		i64 13007301433716123603, ; hash 0xb48337bd031427d3, from name: libYubico.NativeShims
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libYubico.NativeShims.so
		ptr null; void* handle (0x0)
	}, ; 30
	%struct.DSOCacheEntry {
		i64 13250470538856891232, ; hash 0xb7e320c047580360, from name: Yubico.NativeShims
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libYubico.NativeShims.so
		ptr null; void* handle (0x0)
	}, ; 31
	...
	%struct.DSOCacheEntry {
		i64 18027842600207860203, ; hash 0xfa2fc3544c0b41eb, from name: libYubico.NativeShims.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libYubico.NativeShims.so
		ptr null; void* handle (0x0)
	}, ; 40
...
@.env.7 = private unnamed_addr constant [37 x i8] c"f0f62023-62dc-473d-81e4-0478fc08535c\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.phantomvault.mobile\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [13 x i8] c"libsodium.so\00", align 1
@.DSOCacheEntry.10_name = private unnamed_addr constant [25 x i8] c"libYubico.NativeShims.so\00", align 16
