...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "PhantomVault.Mobile.dll" comes first in this list. */
		"PhantomVault.Mobile.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"GiblexVault.Security.ZK.dll",
		"PhantomVault.Core.dll",
